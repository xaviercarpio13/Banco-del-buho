...
public class PagoDeTarjeta extends javax.swing.JFrame {
    ...
    private void btnSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalirActionPerformed
        ConfirmacionPagoTarjeta newframe= new ConfirmacionPagoTarjeta();
        //newframe.setFrmPagoServicio(this);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PagoDeTarjeta().setVisible(true);
            }
        });
    }
